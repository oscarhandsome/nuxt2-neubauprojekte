  ...
  <section class="bg-gray-200">
    <div class="container mx-auto py-5">
      ...
      <div v-if="stats" class="grid md:grid-cols-3 grid-cols-1 gap-5">
        ...
        <div class="flex p-5">
            <div class="block text-3xl font-bold mr-5">{{ stats.countNonExclusive }}</div> 
            <p>
                Immobillienobjekte aus <br>verschiedenen Quellen
            </p>    
        </div>
        <div class="flex p-5">
            <div class="block text-3xl font-bold mr-5">{{ stats.countRealtors ? stats.countRealtors + '+' : '' }}</div> 
            <p>
                Partner vermarkten ihre Neubauten zuerst über uns
            </p>    
        </div>
      </div>
    </div>
