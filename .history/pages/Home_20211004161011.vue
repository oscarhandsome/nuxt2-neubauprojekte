...
import CardPill from "@/components/common/CardPill.vue";
import Button from "@/components/common/Button.vue";
import TeamSection from "@/components/TeamSection.vue";

import { schemaOrgData } from "@/assets/ts/schemaOrgData";
...
export default Vue.extend({
  ...
  jsonld(): any {
    return {
      ...this.schemaOrgData,
      description: this.currentPage.meta[0].content,
    };
  },
  computed: {
    activeBadge() {
    ...
    inActiveBadge() {
      return "bg-monochromatic-purpleGrey text-blue-300";
    },
    steps(): Object {
      return this.stepsData;
    },
    consultationLink(): string {
      return "/clinics/erectile-dysfunction";
    },
  },
});
</script>
...
.gradient-bg {
  background: linear-gradient(to bottom, #f7fafd 50%, #272a3f 50%, #272a3f);
}
